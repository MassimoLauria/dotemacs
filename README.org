...
** Choice and expansion of templates (prefix and completion)
   ...
   by the letter ='a'=. A bit  too agressive IMHO. Instead I will only
   use the prefix ='<'= for my snippet keys, as in =tempo= templates.

   Furthermore I will have a trigger key that activates the snippets.
