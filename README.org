...
** Backup and autosave of files
   ...
   remembers  to save  stuff  from time  to time.  I'd  rather put  my
   all backups and saves in a specific folder.

   First setup the autosave feature
...
#+END_SRC
   ...
   Then we setup the backup features, where copies of old versions are
   kept for local files.
...
(setq backup-directory-alist 
      `(("." . "~/.emacs.d/backups/")
        (,tramp-file-name-regexp .  nil))) ;; where to save
