...
** Cleanup the modeline --- major modes
...
** Cleanup the modeline --- minor modes
...
** Word wrapping and text width
   ...
   - =isual-fill-column-mode= (visual wrap at fixed margin)
...
(use-package visual-fill-column
  ...
  :hook ((visual-line-mode . 'visual-fill-column-mode)
         ...
         (message-hook-mode . 'visual-line-mode)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(setq flycheck-global-modes '(not python-mode c-mode c++-mode objc-mode)) ; Use eglot/flymake
...
#+END_SRC
   ...
   Some useful functions to manage Eglot.
