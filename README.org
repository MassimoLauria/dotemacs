...
#+BEGIN_SRC emacs-lisp
  (defun mxl/tune-modus-theme ()
    ...
    (if (seq-intersection '(modus-vivendi modus-operandi)
  ...
  (use-package modus-themes
    ...
    ;; Gray selection that preserves underlying colors
    (setq modus-themes-common-palette-overrides
	'((bg-region bg-active) 
	  (fg-region unspecified)
	  (fg-heading-1 keyword)))
    :config
...
** Modeline customization
   ...
   Note  that Doom  Emacs Modeline  requires Nerd  fonts. They  should
   be already in my setup.
