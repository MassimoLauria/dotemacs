...
;; Time-stamp: "2014-11-07, 14:00 (CET) Massimo Lauria"
...
;;  and the fallback `minimal-init.el' should.



;; Stop for errors during init loading.
(if (< emacs-major-version 24) (error "Emacs <24 not supported by default configuration. Use fallback one"))
