...
; http://sourceforge.net/projects/cedet/files/cedet/1.0pre6/cedet-1.0pre6.tar.gz/downloa; http://sourceforge.net/projects/ecb/files/ecb/ECB%202.40/ecb-2.40.tar.gz/download

(load-file "/home/massimo/config/emacs/3rdparts/cedet-1.0pre6/common/cedet.el")
(global-ede-mode 1)                      ; Enable the Project management system
(setq semantic-load-turn-useful-things-on t)
(semantic-load-enable-code-helpers)      ; Enable prototype help and smart completion
(global-srecode-minor-mode 1)            ; Enable template insertion menu

(add-to-list 'load-path "/home/massimo/config/emacs/3rdparts/ecb-2.40")
(require 'ecb)
...
;;{{{ *** SAGE Math support ***
(add-to-list 'load-path (expand-file-name "/usr/local/lib/sage-4.1.1/data/emacs"))
(require 'sage "sage")
...
;;
(autoload 'twit-post "twit.el" "Twitter facilities on emacs" t)
