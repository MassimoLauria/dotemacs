;;; yapfify-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
Yapfify whole buffer." t)
(autoload 'yapfify-region-or-buffer "yapfify" "\
Yapfify the region if it is active. Otherwise, yapfify the buffer" t)
